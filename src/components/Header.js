...
export default function Header() {
  return (
    <header className="relative text-center mt-24 md:mt-48 pt-10 md:pt-20 snap-start snap-always">
      <h1 className="text-4xl md:text-6xl font-extrabold text-blue-800 dark:text-yellow-400">Hi, I&apos;m Fredrik Jurgell</h1>
      <p className="text-lg md:text-2xl mt-2 md:mt-4 text-blue-600 dark:text-gray-300">I craft beautiful and functional web experiences.</p>
